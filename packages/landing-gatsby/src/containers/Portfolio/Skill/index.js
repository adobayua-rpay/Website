    ...
    <Box {...sectionWrapper} as="section">
      <Container noGutter mobileGutter width="1200px">
        <Box {...secTitleWrapper}>
          ...
          <Text
            {...secDescription}
            content="Have a look, some could be interesting to help you achieve your business or personal goals or start that project you always wanted to do... Yes, that one!"
          />
        </Box>
