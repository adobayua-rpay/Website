    ...
    <AwardSectionWrapper id="awards_section">
      <Container noGutter mobileGutter width="1200px">
        <Box {...secTitleWrapper}>
          <Heading
            {...secTitle}
            content="My Tech, Product &amp; Software stack"
          />
          <Text
            {...secDescription}
            content="So here is my current tech stack, I also snuck in some products that I enjoy using myself and hopefully you see something on here that you enjoy and perhaps use as well."
          />
        </Box>
